/**
 * POSA_MT920000HT03_Genetics.
 */

function POSA_MT920000HT03_Genetics(appController, messageAndUIBinder, logger) {
	...
	function initialize() {
		...
		try{
			...
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);*/3
