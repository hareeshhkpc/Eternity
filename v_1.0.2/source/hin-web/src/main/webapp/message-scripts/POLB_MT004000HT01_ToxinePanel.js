...
function POLB_MT004000HT01_ToxinePanel(appController, messageAndUIBinder,
		logger) {
	...
	function initialize() {
		...
		try {
			...
			fields = "component2[1],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 35',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[2],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 0.4',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[3],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 117',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[4],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 7',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[5],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 1',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[6],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 15',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[7],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 1',null];
			...
			fields = "component2[8],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 10',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[9],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 0.4',null];
			...
			fields = "component2[10],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			...
			fields = "component2[11],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 4',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[12],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 12',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[13],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 0.3',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[14],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 1',null];
			...
			fields = "component2[15],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 0.8',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[16],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 0.5',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[17],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 0.03',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[18],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 10',null];
			...
			fields = "component2[19],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 0.4',null];
			...
			fields = "component2[20],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 0.04',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
			
			fields = "component2[21],observationEvent,referenceRange,interpretationRange";
			type = "CD";
			tagName = "value";
			pathFields = fields.split(',');
			instanceObject = ['< 35-225',null];
			messageAndUIBinder.writeValueToMessage(tagName, pathFields, type, instanceObject);
		...
		/*
		 * fields = "recordTarget,patient,patientPerson"; type = "II"; var
		 * tagName = "id"; var pathFields = fields.split(','); instanceObject =
		 * [userId, null, null];
		 * 
		 * messageAndUIBinder.writeValueToMessage(tagName, pathFields, type,
		 * instanceObject);
		 * 
		 * fields = "author,employmentStaff,employeePerson"; type = "II"; var
		 * tagName = "id"; var pathFields = fields.split(','); instanceObject =
		 * [userId, null, null];
		 * 
		 * messageAndUIBinder.writeValueToMessage(tagName, pathFields, type,
