...
;(function (win,doc) {
   ...
   // types
   notificationmsg = notifier('log');
   notificationmsg.log = notifier('log');
   notificationmsg.error = notifier('error');
   notificationmsg.info = notifier('info');
   notificationmsg.success = notifier('success');

   // options
   notificationmsg.timeout = 4000;
   notificationmsg.waitForMove = false;
   notificationmsg.clickToClose = false;

   // events
   notificationmsg.on = function(type, handler){ events[type] = handler; };
   win.humane = notificationmsg;
})( window, document );
