	...
	a
			.extend(
					a.mobile.datebox.prototype._build,
					{
						...
						flipbox : function() {
							var l = this, d = this.options, e, j, m, f, k, g = this
									._makeDate(this.d.input.val()), h = "ui-datebox-", c = a("<div class='ui-overlay-shadow'><ul></ul></div>"), b = a(
									"<div>", {
										"class" : h + "flipcontent"
									});
																		...
																		(parseInt(
																				(c.start - c.end)
																						/ c.target
																								.innerHeight(),
																				10) * c.tmp
																				.jqmData("amount")))}c.start=false;c.end=false}})}})})(jQuery);