...
(function($) {
   $.widget("ui.weekCalendar", {
       ...
       options : {
         ...
         use24Hour : false,
         daysToShow : 3,
         firstDayOfWeek :new Date().getDay(), // 0 = Sunday, 1 = Monday, 2 = Tuesday, ... , 6 = Saturday
      ...
      today : function() {
         this._clearCalendar();
         //this._loadCalEvents(new Date( new Date().getTime() - 86400000));
...
/*
      ...
      */
      ...
      _renderCalendar : function() {
         ...
         if (options.buttons) {
            calendarNavHtml = "<div class=\"wc-nav\">\
            		...
            		<button class=\"wc-fday\">Full Calendar</button>\
            ...
            $calendarContainer.find(".wc-nav .wc-fday").click(function() {
                self.element.weekCalendar("fday");
                return false;
             });
      ...
      _loadCalEvents : function(dateWithinWeek) {
         ...
         /***For Day***/
         //weekEndDate = new Date(date.getTime() + MILLIS_IN_1DAY);
      ...
      _renderEvent: function (calEvent, $weekDay) {
        ...
        // wc-time //
         ...
         eventHtml = "<div id=\"draggable\" class=\"" + eventClass + " ui-corner-all\">\
      ...
      _findWeekDayForEvent : function(calEvent, $weekDayColumns) {
         ...
         $weekDayColumns.each(function() {
            if ($(this).data("startDate").getTime() <= calEvent.start.getTime() && $(this).data("endDate").getTime() >= calEvent.end.getTime()) {
               $weekDay = $(this);
               return true; /**Madhu :Change from false  **/
            }
         });
         return $weekDay;
      },
...
alert(""+newCalEvent.end.getTime());
      ...
      _refreshEventDetails : function(calEvent, $calEvent) {
         ...
         if(calEvent.img==undefined){
        	 calEvent.img="images/user.png"; 
         }
         if(calEvent.backgroundColor != undefined){
        	 $calEvent.find(".wc-title").css('background-color','blue');
         }
         var innerHtml = "<div style=\"float:left;margin-top:2px;\"><img border=\"0\" style=\"width:40px;height:50px;\" src='"+ calEvent.img  +"'>" +
  						 "</div><div style=\"text-align:left;font-size:12px;text-shadow:none;overflow: hidden;width: auto;\">"+calEvent.title.replace(',','</br>');+"</div>";
 
  		 $calEvent.find(".wc-title").html(innerHtml);//calEvent.title
   ...
   var MILLIS_IN_1DAY = MILLIS_IN_DAY * 2;
