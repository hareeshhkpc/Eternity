...
function createChatBox(user,minimizeChatBox) {
	...
	//alert(loggedUsers[user].displayName);
	...
	.addClass("chatbox")
	.html('<div class="chatboxhead"><div class="chatboxtitle">'+loggedUsers[user].displayName+'</div><div class="chatboxoptions"><a href="javascript:void(0)" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')">-</a> <a href="javascript:void(0)" onclick="javascript:closeChatBox(\''+chatboxtitle+'\')">X</a></div><br clear="all"/></div><div class="chatboxcontent"></div><div class="chatboxinput" onclick="javascript:activeChatBox(\''+chatboxtitle+'\')"><textarea class="chatboxtextarea" onkeydown="javascript:return checkChatBoxInputKey(event,this,\''+chatboxtitle+'\',\''+user+'\');"></textarea></div>')
	.appendTo($( "body" ));
