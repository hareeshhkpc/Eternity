function SignUp(processDefinition, appController, idGenerator) {
	var thisObject = this;
	...
	this.initialize = function(callBackFunction) {
		...
		var empty = [];
		var object = new Object();
		object.messageType = 'ROLE_USER';
		object.conceptName = 'User';
		object.category = "Role";
		object.lookup = false;
		thisObject.messageCreationMap.put(object, empty);
	...
	this.fillMessage = function(messageType, message, conceptLookup, callback) {
		...
		/*
		 * if (messageType.type == "ROLE_USER") { // message.title =
