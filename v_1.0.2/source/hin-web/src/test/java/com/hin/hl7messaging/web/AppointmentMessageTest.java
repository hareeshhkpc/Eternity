...
public class AppointmentMessageTest {
	...
	public void testCreateAppointment() throws Exception{
		...
		String userXml = getFormattedMessage("src/main/webapp/transformers/test-case-input/Appointment.xml", 
				"src/main/webapp/transformers/test-case-input/Appointment.properties");
		ByteArrayPartSource baps = new ByteArrayPartSource("Registration.xml", userXml.getBytes());
		Part[] parts = new Part[]{ 
				new StringPart("assignedToWhom", "halleydemo"),	
